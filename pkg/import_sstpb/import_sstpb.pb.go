...
func (Pair_OP) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{17, 0}
}

type WriteBatchRequest_OP int32

const (
	WriteBatchRequest_Put    WriteBatchRequest_OP = 0
	WriteBatchRequest_Delete WriteBatchRequest_OP = 1
)

var WriteBatchRequest_OP_name = map[int32]string{
	0: "Put",
	1: "Delete",
}

var WriteBatchRequest_OP_value = map[string]int32{
	"Put":    0,
	"Delete": 1,
}

func (x WriteBatchRequest_OP) String() string {
	return proto.EnumName(WriteBatchRequest_OP_name, int32(x))
}

func (WriteBatchRequest_OP) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{18, 0}
}
...
type WriteBatchRequest struct {
	...
	Op                   []WriteBatchRequest_OP `protobuf:"varint,2,rep,packed,name=op,proto3,enum=import_sstpb.WriteBatchRequest_OP" json:"op,omitempty"`
	Key                  [][]byte               `protobuf:"bytes,3,rep,name=key,proto3" json:"key,omitempty"`
	Value                [][]byte               `protobuf:"bytes,4,rep,name=value,proto3" json:"value,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *WriteBatchRequest) GetCommitTs() uint64 {
	if m != nil {
		return m.CommitTs
	}
	return 0
...
func (m *WriteBatchRequest) GetOp() []WriteBatchRequest_OP {
	if m != nil {
		return m.Op
	}
	return nil
...
func (m *WriteBatchRequest) GetKey() [][]byte {
	if m != nil {
		return m.Key
	}
	return nil
...
func (m *WriteBatchRequest) GetValue() [][]byte {
	if m != nil {
		return m.Value
	}
	return nil
...
type WriteMetaRequest struct {
	Meta                 *SSTMeta `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *WriteMetaRequest) GetMeta() *SSTMeta {
	if m != nil {
		return m.Meta
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("import_sstpb.WriteBatchRequest_OP", WriteBatchRequest_OP_name, WriteBatchRequest_OP_value)
	...
	proto.RegisterType((*WriteBatchRequest)(nil), "import_sstpb.WriteBatchRequest")
	proto.RegisterType((*WriteMetaRequest)(nil), "import_sstpb.WriteMetaRequest")
...
var fileDescriptor_4d076b7935cfab6b = []byte{
	...
	,
}
...
type ImportSSTClient interface {
	...
	WriteBatch(ctx context.Context, opts ...grpc.CallOption) (ImportSST_WriteBatchClient, error)
	WriteMeta(ctx context.Context, opts ...grpc.CallOption) (ImportSST_WriteMetaClient, error)
...
func (c *importSSTClient) WriteBatch(ctx context.Context, opts ...grpc.CallOption) (ImportSST_WriteBatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ImportSST_serviceDesc.Streams[1], "/import_sstpb.ImportSST/WriteBatch", opts...)
	if err != nil {
		return nil, err
	}
	x := &importSSTWriteBatchClient{stream}
	return x, nil
}

type ImportSST_WriteBatchClient interface {
	Send(*WriteBatchRequest) error
	CloseAndRecv() (*WriteResponse, error)
	grpc.ClientStream
}

type importSSTWriteBatchClient struct {
	grpc.ClientStream
}

func (x *importSSTWriteBatchClient) Send(m *WriteBatchRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *importSSTWriteBatchClient) CloseAndRecv() (*WriteResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(WriteResponse)
...
func (c *importSSTClient) WriteMeta(ctx context.Context, opts ...grpc.CallOption) (ImportSST_WriteMetaClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ImportSST_serviceDesc.Streams[2], "/import_sstpb.ImportSST/WriteMeta", opts...)
	if err != nil {
		return nil, err
	}
	x := &importSSTWriteMetaClient{stream}
	return x, nil
}

type ImportSST_WriteMetaClient interface {
	Send(*WriteMetaRequest) error
	CloseAndRecv() (*WriteResponse, error)
	grpc.ClientStream
}

type importSSTWriteMetaClient struct {
	grpc.ClientStream
}

func (x *importSSTWriteMetaClient) Send(m *WriteMetaRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *importSSTWriteMetaClient) CloseAndRecv() (*WriteResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(WriteResponse)
...
func (c *importSSTClient) RawWrite(ctx context.Context, opts ...grpc.CallOption) (ImportSST_RawWriteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ImportSST_serviceDesc.Streams[3], "/import_sstpb.ImportSST/RawWrite", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *importSSTClient) DuplicateDetect(ctx context.Context, in *DuplicateDetectRequest, opts ...grpc.CallOption) (ImportSST_DuplicateDetectClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ImportSST_serviceDesc.Streams[4], "/import_sstpb.ImportSST/DuplicateDetect", opts...)
	if err != nil {
		return nil, err
	}
...
type ImportSSTServer interface {
	...
	// Open a write stream to generate sst files
	WriteBatch(ImportSST_WriteBatchServer) error
	WriteMeta(ImportSST_WriteMetaServer) error
...
func (*UnimplementedImportSSTServer) WriteBatch(srv ImportSST_WriteBatchServer) error {
	return status.Errorf(codes.Unimplemented, "method WriteBatch not implemented")
}
func (*UnimplementedImportSSTServer) WriteMeta(srv ImportSST_WriteMetaServer) error {
	return status.Errorf(codes.Unimplemented, "method WriteMeta not implemented")
}
...
func _ImportSST_WriteBatch_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ImportSSTServer).WriteBatch(&importSSTWriteBatchServer{stream})
}

type ImportSST_WriteBatchServer interface {
	SendAndClose(*WriteResponse) error
	Recv() (*WriteBatchRequest, error)
	grpc.ServerStream
}

type importSSTWriteBatchServer struct {
	grpc.ServerStream
}

func (x *importSSTWriteBatchServer) SendAndClose(m *WriteResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *importSSTWriteBatchServer) Recv() (*WriteBatchRequest, error) {
...
func _ImportSST_WriteMeta_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ImportSSTServer).WriteMeta(&importSSTWriteMetaServer{stream})
}

type ImportSST_WriteMetaServer interface {
	SendAndClose(*WriteResponse) error
	Recv() (*WriteMetaRequest, error)
	grpc.ServerStream
}

type importSSTWriteMetaServer struct {
	grpc.ServerStream
}

func (x *importSSTWriteMetaServer) SendAndClose(m *WriteResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *importSSTWriteMetaServer) Recv() (*WriteMetaRequest, error) {
	m := new(WriteMetaRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _ImportSST_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _ImportSST_WriteBatch_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "WriteMeta",
			Handler:       _ImportSST_WriteMeta_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "RawWrite",
...
func (m *WriteBatchRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Value) > 0 {
		for iNdEx := len(m.Value) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintImportSstpb(dAtA, i, uint64(len(m.Value[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	if len(m.Key) > 0 {
		for iNdEx := len(m.Key) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintImportSstpb(dAtA, i, uint64(len(m.Key[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.Op) > 0 {
		dAtA17 := make([]byte, len(m.Op)*10)
		var j16 int
		for _, num := range m.Op {
			for num >= 1<<7 {
		...
		i = encodeVarintImportSstpb(dAtA, i, uint64(j16))
		i--
		dAtA[i] = 0x12
	}
	if m.CommitTs != 0 {
...
func (m *WriteMetaRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *WriteMetaRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WriteMetaRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *WriteBatchRequest) Size() (n int) {
	...
	if len(m.Op) > 0 {
		l = 0
		for _, e := range m.Op {
			l += sovImportSstpb(uint64(e))
		}
		n += 1 + sovImportSstpb(uint64(l)) + l
	}
	if len(m.Key) > 0 {
		for _, b := range m.Key {
			l = len(b)
...
func (m *WriteMetaRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
		...
		case 2:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= WriteBatchRequest_OP(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.Op) == 0 {
					m.Op = make([]WriteBatchRequest_OP, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v WriteBatchRequest_OP
					for shift := uint(0); ; shift += 7 {
...
func (m *WriteMetaRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WriteMetaRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WriteMetaRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
