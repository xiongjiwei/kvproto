...
type WriteBatch_OP int32

const (
	WriteBatch_Put    WriteBatch_OP = 0
	WriteBatch_Delete WriteBatch_OP = 1
)

var WriteBatch_OP_name = map[int32]string{
	0: "Put",
	1: "Delete",
}

var WriteBatch_OP_value = map[string]int32{
	"Put":    0,
	"Delete": 1,
}

func (x WriteBatch_OP) String() string {
	return proto.EnumName(WriteBatch_OP_name, int32(x))
}

func (WriteBatch_OP) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{18, 0}
}

type WriteRequest_OP int32

const (
	WriteRequest_Put    WriteRequest_OP = 0
	WriteRequest_Delete WriteRequest_OP = 1
)

var WriteRequest_OP_name = map[int32]string{
	0: "Put",
	1: "Delete",
}

var WriteRequest_OP_value = map[string]int32{
	"Put":    0,
	"Delete": 1,
}

func (x WriteRequest_OP) String() string {
	return proto.EnumName(WriteRequest_OP_name, int32(x))
}

func (WriteRequest_OP) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4d076b7935cfab6b, []int{19, 0}
}

type RawWriteBatch_OP int32

const (
	RawWriteBatch_Put    RawWriteBatch_OP = 0
	RawWriteBatch_Delete RawWriteBatch_OP = 1
)

var RawWriteBatch_OP_name = map[int32]string{
	0: "Put",
	1: "Delete",
}

var RawWriteBatch_OP_value = map[string]int32{
	"Put":    0,
	"Delete": 1,
}

func (x RawWriteBatch_OP) String() string {
	return proto.EnumName(RawWriteBatch_OP_name, int32(x))
}

func (RawWriteBatch_OP) EnumDescriptor() ([]byte, []int) {
...
type WriteBatch struct {
	...
	Op                   []WriteBatch_OP `protobuf:"varint,4,rep,packed,name=op,proto3,enum=import_sstpb.WriteBatch_OP" json:"op,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *WriteBatch) GetValue() [][]byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *WriteBatch) GetOp() []WriteBatch_OP {
	if m != nil {
		return m.Op
	}
	return nil
...
type WriteRequest struct {
	...
	Key                  [][]byte          `protobuf:"bytes,2,rep,name=key,proto3" json:"key,omitempty"`
	Value                [][]byte          `protobuf:"bytes,3,rep,name=value,proto3" json:"value,omitempty"`
	Op                   []WriteRequest_OP `protobuf:"varint,4,rep,packed,name=op,proto3,enum=import_sstpb.WriteRequest_OP" json:"op,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *WriteRequest) GetCommitTs() uint64 {
	if m != nil {
		return m.CommitTs
	}
	return 0
...
func (m *WriteRequest) GetOp() []WriteRequest_OP {
	if m != nil {
		return m.Op
	}
	return nil
...
type RawWriteBatch struct {
	...
	Key   [][]byte           `protobuf:"bytes,2,rep,name=key,proto3" json:"key,omitempty"`
	Value [][]byte           `protobuf:"bytes,3,rep,name=value,proto3" json:"value,omitempty"`
	Op    []RawWriteBatch_OP `protobuf:"varint,4,rep,packed,name=op,proto3,enum=import_sstpb.RawWriteBatch_OP" json:"op,omitempty"`
...
func (m *RawWriteBatch) GetKey() [][]byte {
	if m != nil {
		return m.Key
	}
	return nil
...
func (m *RawWriteBatch) GetValue() [][]byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *RawWriteBatch) GetOp() []RawWriteBatch_OP {
	if m != nil {
		return m.Op
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("import_sstpb.WriteBatch_OP", WriteBatch_OP_name, WriteBatch_OP_value)
	proto.RegisterEnum("import_sstpb.WriteRequest_OP", WriteRequest_OP_name, WriteRequest_OP_value)
	proto.RegisterEnum("import_sstpb.RawWriteBatch_OP", RawWriteBatch_OP_name, RawWriteBatch_OP_value)
...
var fileDescriptor_4d076b7935cfab6b = []byte{
	...
	,
}
...
func (m *WriteRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Op) > 0 {
		...
		i = encodeVarintImportSstpb(dAtA, i, uint64(j18))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Value) > 0 {
...
func (m *RawWriteBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Op) > 0 {
		...
		i = encodeVarintImportSstpb(dAtA, i, uint64(j21))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Value) > 0 {
		...
		case 4:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.Op) == 0 {
					m.Op = make([]WriteBatch_OP, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v WriteBatch_OP
					for shift := uint(0); ; shift += 7 {
		...
		case 4:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= WriteRequest_OP(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				var elementCount int
				if elementCount != 0 && len(m.Op) == 0 {
					m.Op = make([]WriteRequest_OP, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v WriteRequest_OP
					for shift := uint(0); ; shift += 7 {
		...
		case 4:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= RawWriteBatch_OP(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				var elementCount int
				if elementCount != 0 && len(m.Op) == 0 {
					m.Op = make([]RawWriteBatch_OP, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v RawWriteBatch_OP
					for shift := uint(0); ; shift += 7 {
